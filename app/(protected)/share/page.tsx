    ...
    <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 max-w-[1600px] mx-auto space-y-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-base font-semibold text-foreground">
          Keep share links, signatures, and follow-ups tight.
        </p>
        <Button asChild size="sm">
          <Link href="/share/links">New share link</Link>
        </Button>
      </div>

      <div className="flex flex-wrap gap-2">
        <Button asChild variant="outline" size="sm">
          <Link href="/share/links">View share links</Link>
        </Button>
        <Button asChild variant="outline" size="sm">
          <Link href="/signatures">View signatures</Link>
        </Button>
        <Button asChild variant="outline" size="sm">
          <Link href="/share/contacts">Manage contacts</Link>
        </Button>
      </div>
              ...
              <div className="space-y-2">
                ...
                {followups.length === 0 && (
                  <div className="flex h-full flex-col items-center justify-center gap-2 text-center">
                    <div className="text-sm font-medium text-foreground">No follow-ups yet</div>
                    <div className="text-xs text-muted-foreground">
                      Send a share link or signature request to start tracking.
                    </div>
                    <Button asChild variant="outline" size="sm">
              ...
              <div className="space-y-1">
                ...
                {shareLinks.length === 0 && (
                  <div className="flex h-full flex-col items-center justify-center gap-2 text-center">
                    ...
                    <div className="text-xs text-muted-foreground">
                      Create a share link to start tracking views and engagement.
                    </div>
                    <Button asChild variant="outline" size="sm">
          ...
          <div className={`md:col-span-6 ${BREAKDOWNS_ROW_CARD_HEIGHT}`}>
            <WidgetCard title="Recipients / Companies" subtitle="Shared with" className="h-full">
              <div className="space-y-1">
                ...
                {companies.length === 0 && (
                  <div className="flex h-full flex-col items-center justify-center gap-2 text-center">
                    <div className="text-sm font-medium text-foreground">No recipients yet</div>
                    <div className="text-xs text-muted-foreground">
                      Share a document or add contacts to build your list.
                    </div>
                    <Button asChild variant="outline" size="sm">
                      <Link href="/share/contacts">Manage contacts</Link>
                    </Button>
